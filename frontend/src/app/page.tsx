...
import {
  ...
  ShieldCheck, Lock, TrendingUp, Target, Bell, Star,
} from "lucide-react";
...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 dark:bg-[#0b0e11] dark:text-slate-100 transition-colors duration-300 overflow-x-hidden">
      ...
      {/* Footer */}
      <footer className="border-t border-slate-200/80 bg-white py-10 dark:border-white/[0.08] dark:bg-[#0b0e11]">
        <div className="mx-auto grid max-w-6xl gap-6 px-4 sm:px-6 grid-cols-2 sm:grid-cols-2 md:grid-cols-4">
          <div>
            <div className="flex items-center gap-2">
              <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-[#bbf246] text-[#0b0e11] font-black shadow-sm shadow-[#bbf246]/25">
                <Wallet className="h-4 w-4 stroke-[2.5]" />
              </div>
              <span className="font-extrabold text-slate-900 dark:text-white">FinTrack</span>
            </div>
            <p className="mt-2.5 text-sm text-slate-500 dark:text-slate-400 leading-relaxed">Take Control of Your Money. Built for modern India.</p>
          </div>
          <div>
            ...
            <div className="mt-3 space-y-2 text-sm text-slate-500 dark:text-slate-400">
              <a href="#features" className="block hover:text-slate-900 dark:hover:text-[#bbf246] transition">Features</a>
              <a href="#how" className="block hover:text-slate-900 dark:hover:text-[#bbf246] transition">How it works</a>
              <a href="#cta" className="block hover:text-slate-900 dark:hover:text-[#bbf246] transition">Get Started</a>
            </div>
          </div>
          <div>
          ...
          <div>
            ...
            <a href="https://github.com" className="mt-3 inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-slate-900 dark:text-slate-400 dark:hover:text-[#bbf246] transition">
              <Code2 className="h-4 w-4" /> GitHub
            </a>
          </div>
        </div>
        <div className="mt-8 border-t border-slate-100 dark:border-white/[0.06] pt-6 text-center text-xs text-slate-400 dark:text-slate-500">
          © 2026 FinTrack. All rights reserved. Made with ❤️ for India.
        </div>
      </footer>
    </div>
  );
