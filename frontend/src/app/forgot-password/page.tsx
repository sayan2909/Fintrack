                ...
                <div className="space-y-4 animate-fade-up">
                  ...
                  <div className="space-y-2.5 pt-2">
                    <Link
                      ...
                      className="flex w-full items-center justify-center gap-2 rounded-2xl bg-[#bbf246] hover:bg-[#a8e030] text-[#0b0e11] py-3.5 px-4 text-sm font-black transition-all duration-200 active:scale-[0.98] shadow-lg shadow-[#bbf246]/25"
                    >
                  ...
                  <div className="pt-2 text-center">
                    <button
                      ...
                      className="text-xs font-semibold text-slate-400 hover:text-slate-600 dark:hover:text-[#bbf246] cursor-pointer transition"
                    >
