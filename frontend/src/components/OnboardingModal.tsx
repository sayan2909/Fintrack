      ...
      content: (
        <div className="space-y-3.5 pt-2">
          ...
          <div className="flex items-start gap-3 rounded-2xl border border-slate-100 bg-slate-50/60 p-3.5 dark:border-slate-800 dark:bg-slate-800/40">
            <div className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-xl bg-slate-900 text-emerald-500 font-black shadow-sm">
        ...
        <div className="space-y-3 pt-2">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-3.5 shadow-sm dark:border-slate-800 dark:bg-slate-800/70">
            <div className="flex items-center justify-between text-xs font-bold">
              ...
              <span className="text-slate-900 dark:text-emerald-400">₹45,000 / ₹1,00,000 (45%)</span>
            </div>
            <div className="mt-2 h-2 w-full overflow-hidden rounded-full bg-slate-100 dark:bg-slate-700">
              <div className="h-full w-[45%] rounded-full bg-gradient-to-r from-emerald-500 to-teal-400" />
            </div>
          </div>
        </div>
      ),
      ...
      content: (
        <div className="grid gap-3 pt-2 sm:grid-cols-2">
          <button
            ...
            className="flex flex-col items-center justify-center gap-2 rounded-2xl border-2 border-dashed border-slate-200 dark:border-white/10 bg-emerald-500/10 p-4 text-center transition hover:border-emerald-500 hover:bg-emerald-500/10 dark:border-emerald-500/20 dark:bg-emerald-500/10 dark:hover:bg-emerald-500/10 cursor-pointer"
          >
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-slate-900 text-white dark:bg-white/10 dark:text-white dark:border dark:border-white/10 font-bold shadow-md">
              <PlusCircle className="h-5 w-5 stroke-[2.5]" />
            </div>
            <p className="text-xs font-bold text-slate-900 dark:text-emerald-400">Log First Transaction</p>
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/60 p-4 backdrop-blur-sm animate-fade-up">
      ...
      >
          ...
          {STEPS.map((_, idx) => (
            <div
              ...
              className={`h-1.5 rounded-full transition-all duration-300 ${
                idx === step ? "w-8 bg-emerald-500" : "w-2 bg-slate-200 dark:bg-slate-700"
              }`}
            />
          ))}
        </div>
        ...
        <div className="relative mb-4 flex h-14 w-14 items-center justify-center">
          <div className="absolute inset-0 animate-pulse rounded-2xl bg-emerald-500/10 blur-lg" />
